...
project_setup[2]{type,requirement}:
  python,"uv venv .venv"
  structure_view,"eza --all --tree --git"
...
threat_protection[6]{threat_type,mitigation_required}:
  "Prompt injection","Input validation & filtering"
  "Data exfiltration","Access controls & monitoring"
  "Social engineering","User awareness & verification"
  "Jailbreak attempts","Context boundaries & validation"
  "Malicious instructions","Instruction sanitization"
